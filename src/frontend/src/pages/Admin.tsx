    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center px-4">
        <div className="text-center max-w-lg w-full">
          ...
          {/* Instagram developer contact */}
          <div className="bg-gradient-to-r from-pink-50 to-purple-50 border border-pink-200 rounded-xl p-4 mb-5 flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-pink-500 via-purple-500 to-orange-400 flex items-center justify-center shrink-0">
              <svg
            ...
            <div className="text-left">
              <p className="text-sm font-semibold text-purple-800">
                इंस्टाग्राम के माध्यम से डेवलपर से संपर्क करें
              </p>
              <a
                href="https://www.instagram.com/omkar.dansana"
                target="_blank"
                rel="noopener noreferrer"
                className="text-xs text-pink-600 hover:text-pink-800 font-mono hover:underline"
              >
                इंस्टाग्राम:- omkar.dansana
              </a>
            </div>
          </div>
