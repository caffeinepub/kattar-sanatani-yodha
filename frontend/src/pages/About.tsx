  ...
  const principles = [
    {
      ...
      description: 'सनातन धर्म के अटल रक्षक बनना, यह सुनिश्चित करना कि इसके सिद्धांत सभी पीढ़ियों के लिए जीवंत और प्रासंगिक बने रहें।',
    },
    {
      icon: Eye,
      title: 'हमारी दृष्टि',
      description: 'एक ऐसी दुनिया जहाँ सनातन धर्म की शाश्वत बुद्धि मानवता को धार्मिकता, शांति और आध्यात्मिक पूर्णता की ओर मार्गदर्शन करे।',
    },
    {
      icon: Award,
      title: 'हमारे मूल्य',
      description: 'धर्म (धार्मिकता), सत्य (सच्चाई), अहिंसा (अहिंसा), सेवा (निःस्वार्थ सेवा), और भक्ति (समर्पण)।',
    },
    {
      icon: Users,
      title: 'हमारा समुदाय',
      description: 'साझा आस्था, परस्पर सम्मान और धार्मिक जीवन के प्रति प्रतिबद्धता से एकजुट समर्पित व्यक्तियों का एक विविध परिवार।',
    },
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 font-serif text-lg text-muted-foreground leading-relaxed">
              ...
              <p>
                हमारा संगठन समुदायों को शिक्षित, प्रेरित और सशक्त बनाने के लिए जमीनी स्तर पर काम करता है। सांस्कृतिक कार्यक्रमों, आध्यात्मिक प्रवचनों, सामाजिक सेवा पहलों और शैक्षिक गतिविधियों के माध्यम से, हम भविष्य की पीढ़ियों के लिए धर्म की ज्योति को प्रज्वलित रखने का प्रयास करते हैं।
              </p>
            </div>
          </div>
        </div>
