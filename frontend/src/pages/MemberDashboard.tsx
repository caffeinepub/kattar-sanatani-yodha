...
import { User, CreditCard, LogOut, CheckCircle, Loader2, MessageCircle, Phone } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { useMemberAuth } from '../hooks/useMemberAuth';
import { useGetCallerMember, useSubmitIdCardRequest } from '../hooks/useMemberQueries';
...
export default function MemberDashboard() {
  ...
  const handleIdCardRequest = async () => {
    ...
    try {
      ...
      const msg = err instanceof Error ? err.message : 'अनुरोध विफल। कृपया पुनः प्रयास करें।';
      setIdCardError(msg);
    }
  };
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-foreground/60 text-sm mt-1">आपके सदस्यता डैशबोर्ड में आपका स्वागत है</p>
          </div>
        ...
        {member && (
          <div className="bg-card border border-border rounded-2xl shadow-warm p-6">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h2 className="font-display text-lg font-semibold text-primary">प्रोफ़ाइल जानकारी</h2>
            </div>
        ...
        <div className="bg-card border border-border rounded-2xl shadow-warm p-6">
          <div className="flex items-center gap-3 mb-5">
            ...
            <h2 className="font-display text-lg font-semibold text-primary">पहचान पत्र (ID Card)</h2>
          </div>
          ...
          {idCardSuccess ? (
            <div className="flex items-start gap-3 bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-xl p-4">
              ...
              <div>
                <p className="font-semibold text-green-700 dark:text-green-400">अनुरोध सफलतापूर्वक भेजा गया!</p>
                <p className="text-sm text-green-600 dark:text-green-500 mt-1">आपका ID Card अनुरोध प्रशासन को भेज दिया गया है।</p>
              </div>
            </div>
          ) : (
            <div className="space-y-4">
              ...
              <div className="bg-primary/5 border border-primary/20 rounded-xl p-4">
                <p className="text-foreground/80 leading-relaxed text-sm md:text-base font-medium">
                  कार्ड के लिए <span className="text-primary font-bold">101 राशी अनुदान करे</span> जो अपनी पार्टी का फंड जमा होगा।
                </p>
              ...
              >
                {submitIdCard.isPending ? (
                  <><Loader2 className="h-4 w-4 mr-2 animate-spin" />अनुरोध भेजा जा रहा है...</>
                ) : (
