    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-3xl font-bold text-primary mb-2">सदस्य लॉगिन</h1>
        ...
        <div className="bg-card border border-border rounded-2xl shadow-warm p-6 md:p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <Label htmlFor="emailOrPhone" className="text-foreground/80 font-medium">
            ...
            >
              {isLoggingIn ? (
                <><Loader2 className="h-4 w-4 mr-2 animate-spin" />लॉगिन हो रहा है...</>
              ) : (
                'लॉगिन करें'
              )}
            </Button>
